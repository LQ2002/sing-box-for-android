...
class EditProfileActivity : AbstractActivity<ActivityEditProfileBinding>() {
    ...
    private suspend fun loadProfile() {
        ...
        withContext(Dispatchers.Main) {
            ...
            binding.type.text = getString(profile.typed.type.stringResId)
            ...
            when (profile.typed.type) {
                ...
                TypedProfile.Type.Remote -> {
                    ...
                    binding.autoUpdate.text = EnabledType.from(profile.typed.autoUpdate).getLocalizedString(this@EditProfileActivity)
    ...
    private fun updateAutoUpdate(newValue: String) {
        val boolValue = EnabledType.fromLocalizedString(this, newValue).boolValue
