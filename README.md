...
# 🌹
[ DevDengChao](https://github.com/DevDengChao/sing-box-for-android/tree/fix/multiple-error-dialog-when-scan-invalid-qr-code) fix/multiple-error-dialog-when-scan-invalid-qr-code
